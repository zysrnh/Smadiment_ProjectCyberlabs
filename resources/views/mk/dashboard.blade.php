...
@section('styles')
    <style>
        ...
        .proj-list-scroll::-webkit-scrollbar {
            width: 4px;
        }

        .proj-list-scroll::-webkit-scrollbar-thumb {
...
@section('content')
                ...
                <div class="card-body py-3">
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div class="d-flex align-items-center gap-3">
                            <div class="avtar avtar-s rounded"
                                style="width:42px;height:42px;background:var(--dash-primary);color:#fff;font-weight:800;font-size:15px;">
                                {{ $initials }}</div>
                            <div>
                ...
                <div class="card-body p-0">
                    <div class="p-3 border-bottom">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" class="form-control border-start-0" id="sidebarSearch"
                    ...
                    <div class="proj-list-scroll" id="projList">
                        @forelse($projects as $project)
                            ...
                            @endphp
                            <div class="proj-item d-flex align-items-center p-3 border-bottom" data-id="{{ $pId }}"
                                data-name="{{ strtolower($pTitle) }}">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="mb-0 text-muted f-12">
                                        {{ $pGroup ? $pGroup . ' · ' : '' }}{{ number_format($pTotal) }} mentions</p>
                                </div>
                                <div class="flex-shrink-0">
            ...
            <div id="chartsArea">
                ...
                <div id="actualCards" style="display:none;">
                    @forelse($projects as $project)
                        ...
                        <div class="card lazy-card mb-3" id="proj-card-{{ $id }}" data-project-id="{{ $id }}"
                            data-loaded="false">
                            ...
                            <div class="card-header">
                                ...
                                <div class="d-flex gap-2 mt-3 flex-wrap">
                                    ...
                                    <span class="badge bg-light-success text-success"><i
                                            class="ph ph-globe me-1"></i>{{ $media }}</span>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-2 mb-3">
                                    ...
                                    <div class="col-6 col-lg-3">
                                        <div class="stat-chip clickable p-2 rounded-2 text-center"
                                            ...
                                            <small
                                                class="text-muted d-block mb-1 f-10 fw-semibold text-uppercase">Positive</small>
                                    ...
                                    <div class="col-6 col-lg-3">
                                        <div class="stat-chip clickable p-2 rounded-2 text-center"
                                            ...
                                            <small
                                                class="text-muted d-block mb-1 f-10 fw-semibold text-uppercase">Neutral</small>
                                    ...
                                    <div class="col-6 col-lg-3">
                                        <div class="stat-chip clickable p-2 rounded-2 text-center"
                                            ...
                                            <small
                                                class="text-muted d-block mb-1 f-10 fw-semibold text-uppercase">Negative</small>
                                ...
                                <div class="chart-container" id="chart-wrap-{{ $id }}">
                                    ...
                                    <div id="chart-{{ $id }}" style="width:100%;height:280px;display:none;cursor:pointer;">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="do-plat-picker" id="dashPlatPicker">
        ...
        <button class="do-plat-btn" onclick="DashPanel.openPlatform('twit','all')">X / Twitter <span class="do-plat-dot"
                style="background:#1d9bf0;"></span></button>
        <button class="do-plat-btn" onclick="DashPanel.openPlatform('fb','all')">Facebook <span class="do-plat-dot"
                style="background:#1877f2;"></span></button>
        <button class="do-plat-btn" onclick="DashPanel.openPlatform('instagram','all')">Instagram <span class="do-plat-dot"
                style="background:#e1306c;"></span></button>
        <button class="do-plat-btn" onclick="DashPanel.openPlatform('youtube','all')">YouTube <span class="do-plat-dot"
                style="background:#ff0000;"></span></button>
        <button class="do-plat-btn" onclick="DashPanel.openPlatform('tiktok','all')">TikTok <span class="do-plat-dot"
