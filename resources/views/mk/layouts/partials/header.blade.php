                        ...
                        <div class="dropdown-body text-wrap header-notification-scroll position-relative"
                            ...
                            <div class="card bg-transparent mb-2 border-0">
                                <div class="card-body p-3 rounded"
                                     style="background: rgba(var(--bs-light-rgb), 0.3);">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <div class="bg-primary bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center"
                                                 style="width:40px;height:40px;">
                                                <i class="ph ph-chart-line text-primary" style="font-size:16px;"></i>
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <span class="float-end text-sm text-muted">Just now</span>
                                            <h5 class="text-body mb-2">New Data Available</h5>
                                            <p class="mb-0">Analytics data for your project has been updated.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <div class="bg-success bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center"
                                                 style="width:40px;height:40px;">
                                                <i class="ph ph-trend-up text-success" style="font-size:16px;"></i>
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <span class="float-end text-sm text-muted">1 hour ago</span>
                                            <h5 class="text-body mb-2">Sentiment Spike Detected</h5>
                                            <p class="mb-0">Positive sentiment increased by 18% in the last 24h.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <div class="bg-warning bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center"
                                                 style="width:40px;height:40px;">
                                                <i class="ph ph-robot text-warning" style="font-size:16px;"></i>
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <span class="float-end text-sm text-muted">3 hours ago</span>
                                            <h5 class="text-body mb-2">AI Analysis Ready</h5>
                                            <p class="mb-0">Monthly AI report for your project is complete.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
{{-- ── Date Picker Modal (tetap dari layout lama) ── --}}
