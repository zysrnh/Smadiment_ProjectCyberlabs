...
@section('title', 'Gender Distribution - SMADIMENT')
...
<div class="top-bar">
  <div class="page-title">
    <h2>Authors Gender Distribution</h2>
    <div class="page-subtitle">Analyze gender demographics of social media authors</div>
  </div>
</div>
...
<div style="display: grid; grid-template-columns: 2fr 1fr; gap: 32px;">
  ...
  <div>
    ...
    <div class="section">
      <div class="section-header">
        <h3 class="section-title">Gender Groups Analysis</h3>
      </div>
      ...
      <div class="section-body">
        ...
        @if(!$hasData)
          <div class="empty-state">
            ...
            <div class="empty-text">No gender distribution data available. Please select a project.</div>
          </div>
        @else
          <!-- Mode Toggle -->
  ...
  <div>
    @include('mk.components.analytics-form', [
      ...
      'showMedia' => true,
      'showSentiment' => false,
      'helperText' => 'Data from /authors_gender endpoint'
    ])
  </div>
