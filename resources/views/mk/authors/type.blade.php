...
@section('title', 'Authors Type Distribution - SMADIMENT')
...
<div class="top-bar">
  <div class="page-title">
    <h2>Authors Type Distribution</h2>
    <div class="page-subtitle">Analyze organization vs individual author demographics</div>
  </div>
</div>
...
<div style="display: grid; grid-template-columns: 2fr 1fr; gap: 32px;">
  ...
  <div>
    ...
    <div class="section">
      <div class="section-header">
        <h3 class="section-title">Author Type Analysis</h3>
      </div>
  ...
  <div>
    @include('mk.components.analytics-form', [
      ...
      'showMedia' => true,
      'showSentiment' => false,
      'helperText' => 'Data from /authors_type endpoint'
    ])
  </div>
  ...
  barChart = new Chart(barCtx, {
    ...
    options: {
      ...
      plugins: {
        ...
        title: {
          display: true,
          text: 'Authors Type Distribution - Bar Chart',
          font: {
            size: 16,
            weight: 'bold',
            family: 'Montserrat'
