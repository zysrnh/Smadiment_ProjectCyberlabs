...
@section('title', 'YouTube Top Hashtags - SMADIMENT')
...
<style>
    ...
    .apply-btn:hover { transform: translateY(-2px); box-shadow: 0 6px 20px rgba(255,0,0,0.3); }
    ...
    .stat-card:hover { transform: translateY(-2px); box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1); border-color: #FF0000; }
    ...
    .btn-view:hover { background: #FF0000; color: white; border-color: #FF0000; }
    ...
    .page-btn:hover:not(:disabled) { border-color: #FF0000; color: #FF0000; background: rgba(255,0,0,0.05); }
    .page-btn.active { background: linear-gradient(135deg, #FF0000 0%, #cc0000 100%); color: white; border-color: transparent; box-shadow: 0 2px 8px rgba(255,0,0,0.3); }
    ...
    .date-picker-trigger:hover { border-color: #FF0000; background: #ffffff; box-shadow: 0 0 0 3px rgba(255,0,0,0.1); }
    ...
    .date-preset:hover  { background: #ffffff; color: #FF0000; }
    ...
    .calendar-day.today       { border: 2px solid #FF0000; }
    .calendar-day.in-range    { background: rgba(255,0,0,0.1); color: #FF0000; }
    .calendar-day.range-start,
    .calendar-day.range-end,
    .calendar-day.selected    { background: linear-gradient(135deg, #FF0000 0%, #cc0000 100%) !important; color: white !important; border: none !important; }
    ...
    .apply-date-btn {
        ...
        font-size: 14px; font-weight: 600; cursor: pointer; transition: all 0.2s; border: none;
        background: linear-gradient(135deg, #FF0000 0%, #cc0000 100%);
        color: white; box-shadow: 0 4px 12px rgba(255,0,0,0.2);
    }
...
<div class="dashboard-container">
    ...
    <div class="page-header">
        <h1>YouTube Top Hashtags</h1>
        <p>Hashtag paling populer di YouTube berdasarkan jumlah mention dalam periode yang dipilih</p>
    </div>
    ...
    <div class="filter-card">
        <form id="filterForm" method="GET" action="{{ route('mk.youtube.trending-topics') }}">
        ...
        <div class="table-wrapper">
            ...
            <div id="emptyState" style="display:none;">
                <div class="empty-state">
                    ...
                    <p>Tidak ada data hashtag YouTube untuk periode ini. Coba ubah tanggal filter.</p>
                </div>
            </div>
        </div>
...
const HashtagApp = {
    ...
    createRow(h, rank) {
        ...
        const fmt  = n => new Intl.NumberFormat('en-US').format(n);
        const link = 'https://www.youtube.com/hashtag/' + encodeURIComponent(name);
            ...
            '<td class="mentions-cell">' +
                '<div style="display:flex;align-items:center;gap:10px;">' +
                    '<div style="flex:1;height:8px;background:#f1f5f9;border-radius:4px;overflow:hidden;">' +
                        '<div style="height:100%;width:' + pct + '%;background:linear-gradient(90deg,#FF0000,#cc0000);border-radius:4px;transition:width 0.8s ease;"></div>' +
                    '</div>' +
