...
@section('title', 'YouTube Overview - SMADIMENT')
...
@section('page-title', 'YouTube Overview')
...
{{-- KPI --}}
<div class="row mb-3">
    <div class="col-md-6 col-xl-3"><div class="card h-100 bg-primary text-white kpi-card-hover fade-up fade-up-d1"><div class="card-body"><div class="d-flex align-items-center"><div class="flex-grow-1"><p class="mb-1 text-white text-opacity-75 f-12">Total Views</p><h3 class="mb-0 text-white f-w-300" id="kpiViews"><span class="sk-block" style="width:80px;height:24px;display:inline-block;"></span></h3><p class="mb-0 mt-2 text-white text-opacity-75 f-12" id="kpiViewsSub"><i class="ph ph-chart-line-up me-1"></i>Loading…</p></div><div class="flex-shrink-0 ms-3"><div class="kpi-icon-bg"><i class="ph ph-eye"></i></div></div></div></div></div></div>
    <div class="col-md-6 col-xl-3"><div class="card h-100 bg-success text-white kpi-card-hover fade-up fade-up-d2"><div class="card-body"><div class="d-flex align-items-center"><div class="flex-grow-1"><p class="mb-1 text-white text-opacity-75 f-12">Total Likes</p><h3 class="mb-0 text-white f-w-300" id="kpiLikes"><span class="sk-block" style="width:80px;height:24px;display:inline-block;"></span></h3><p class="mb-0 mt-2 text-white text-opacity-75 f-12" id="kpiLikesSub"><i class="ph ph-thumbs-up me-1"></i>Loading…</p></div><div class="flex-shrink-0 ms-3"><div class="kpi-icon-bg"><i class="ph ph-thumbs-up"></i></div></div></div></div></div></div>
    <div class="col-md-6 col-xl-3"><div class="card h-100 bg-warning text-white kpi-card-hover fade-up fade-up-d3"><div class="card-body"><div class="d-flex align-items-center"><div class="flex-grow-1"><p class="mb-1 text-white text-opacity-75 f-12">Total Comments</p><h3 class="mb-0 text-white f-w-300" id="kpiComments"><span class="sk-block" style="width:80px;height:24px;display:inline-block;"></span></h3><p class="mb-0 mt-2 text-white text-opacity-75 f-12" id="kpiCommentsSub"><i class="ph ph-chat-circle me-1"></i>Loading…</p></div><div class="flex-shrink-0 ms-3"><div class="kpi-icon-bg"><i class="ph ph-chat-circle"></i></div></div></div></div></div></div>
    <div class="col-md-6 col-xl-3"><div class="card h-100 bg-danger text-white kpi-card-hover fade-up fade-up-d4"><div class="card-body"><div class="d-flex align-items-center"><div class="flex-grow-1"><p class="mb-1 text-white text-opacity-75 f-12">Total Engagement</p><h3 class="mb-0 text-white f-w-300" id="kpiEng"><span class="sk-block" style="width:80px;height:24px;display:inline-block;"></span></h3><p class="mb-0 mt-2 text-white text-opacity-75 f-12" id="kpiEngSub"><i class="ph ph-chart-bar me-1"></i>Loading…</p></div><div class="flex-shrink-0 ms-3"><div class="kpi-icon-bg"><i class="ph ph-chart-bar"></i></div></div></div></div></div></div>
</div>
...
<div class="page-export-bar" data-html2canvas-ignore="true">
    ...
    <div class="page-export-bar-right">
        <button type="button" class="page-export-btn page-export-btn-pdf" id="pageExportPdfBtn"
                onclick="YTExport.run('pdf',this)" title="Export halaman sebagai PDF">
        ...
        <button type="button" class="page-export-btn page-export-btn-img" id="pageExportImgBtn"
                onclick="YTExport.run('image',this)" title="Export halaman sebagai PNG">
            ...
            <div class="card mb-3" style="animation:fadeUp .38s ease-out .18s both;">
                <div id="card-export-hashtag-list">
                    <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div class="d-flex align-items-center gap-2"><div class="avtar avtar-xs bg-light-primary rounded"><i class="ph ph-hash f-18 text-primary"></i></div><div><h6 class="mb-0">Top Hashtags</h6><small class="text-muted">Klik untuk lihat video terkait</small></div></div>
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="d-flex gap-1" data-html2canvas-ignore="true">
                                <button class="card-exp-btn card-exp-btn-pdf" onclick="YTExport.runCard('card-export-hashtag-list','hashtag-list','pdf',this)" title="Export PDF"><i class="ph ph-file-pdf export-icon"></i><span class="export-spinner"></span></button>
                                <button class="card-exp-btn card-exp-btn-img" onclick="YTExport.runCard('card-export-hashtag-list','hashtag-list','image',this)" title="Export PNG"><i class="ph ph-image export-icon"></i><span class="export-spinner"></span></button>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-5 col-12">
            <div class="card mb-3" style="animation:fadeUp .38s ease-out .22s both;">
                <div id="card-export-hashtag-donut">
                    <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div class="d-flex align-items-center gap-2"><div class="avtar avtar-xs bg-light-primary rounded"><i class="ph ph-chart-donut f-18 text-primary"></i></div><div><h6 class="mb-0">Distribusi — Top 5</h6><small class="text-muted">Proporsi penggunaan hashtag teratas</small></div></div>
                        <div class="d-flex align-items-center gap-2 flex-wrap">
                            <div id="donutHashtagLegend" class="donut-legend"></div>
                            <div class="d-flex gap-1" data-html2canvas-ignore="true">
                                <button class="card-exp-btn card-exp-btn-pdf" onclick="YTExport.runCard('card-export-hashtag-donut','hashtag-donut','pdf',this)" title="Export PDF"><i class="ph ph-file-pdf export-icon"></i><span class="export-spinner"></span></button>
                                <button class="card-exp-btn card-exp-btn-img" onclick="YTExport.runCard('card-export-hashtag-donut','hashtag-donut','image',this)" title="Export PNG"><i class="ph ph-image export-icon"></i><span class="export-spinner"></span></button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
...
<div class="tme-tab-panel" id="panel-{{ $tp }}">
    ...
    <div class="card mb-3" style="animation:fadeUp .38s ease-out .18s both;">
        <div id="card-export-donut-{{ $tp }}">
            <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                <div class="d-flex align-items-center gap-2"><div class="avtar avtar-xs bg-light-primary rounded"><i class="ph ph-chart-donut f-18 text-primary"></i></div><div><h6 class="mb-0">Distribusi {{ $panelLabels[$tp] }} — Top 5</h6><small class="text-muted">Proporsi engagement per video — klik untuk detail</small></div></div>
                <div class="d-flex align-items-center gap-2 flex-wrap">
                    <div id="donutLegend-{{ $tp }}" class="donut-legend"></div>
                    <div class="d-flex gap-1" data-html2canvas-ignore="true">
                        <button class="card-exp-btn card-exp-btn-pdf" onclick="YTExport.runCard('card-export-donut-{{ $tp }}','donut-{{ $tp }}','pdf',this)" title="Export PDF"><i class="ph ph-file-pdf export-icon"></i><span class="export-spinner"></span></button>
                        <button class="card-exp-btn card-exp-btn-img" onclick="YTExport.runCard('card-export-donut-{{ $tp }}','donut-{{ $tp }}','image',this)" title="Export PNG"><i class="ph ph-image export-icon"></i><span class="export-spinner"></span></button>
                    </div>
                </div>
            </div>
            <div class="card-body">
    ...
    <div class="card mb-3" style="animation:fadeUp .38s ease-out .22s both;">
        <div id="card-export-list-{{ $tp }}">
            <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                <div class="d-flex align-items-center gap-2"><div class="avtar avtar-xs bg-light-primary rounded"><i class="ph {{ $panelIcons[$tp] }} f-18 text-primary"></i></div><div><h6 class="mb-0">Top Videos by {{ $panelLabels[$tp] }}</h6><small class="text-muted">Klik video untuk lihat detail</small></div></div>
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="d-flex gap-1" data-html2canvas-ignore="true">
                        <button class="card-exp-btn card-exp-btn-pdf" onclick="YTExport.runCard('card-export-list-{{ $tp }}','list-{{ $tp }}','pdf',this)" title="Export PDF"><i class="ph ph-file-pdf export-icon"></i><span class="export-spinner"></span></button>
                        <button class="card-exp-btn card-exp-btn-img" onclick="YTExport.runCard('card-export-list-{{ $tp }}','list-{{ $tp }}','image',this)" title="Export PNG"><i class="ph ph-image export-icon"></i><span class="export-spinner"></span></button>
                    </div>
                </div>
            </div>
...
<div class="do-panel" id="ovSntPanel">
    <div class="do-panel-header">
        ...
        <span class="do-panel-title" id="ovPanelTitle">YouTube Videos</span>
...
const PLAT     = 'YouTube';
const API_BASE = '/mk/api/youtube';
const OVCfg    = { pid:OV_PID, sd:OV_SD, ed:OV_ED, primary:'#038047', colors:{view:'#038047',like:'#10B981',comment:'#F59E0B',hashtag:'#038047'}, perPage:10 };
...
const OVData={
    ...
    _renderDonutHashtag(h){const ld=_$('loadingDonutHashtag'),ch=_$('donutHashtagChart');if(!ld||!ch||!h.length){hideLd('loadingDonutHashtag');return}this._renderDonutEcharts(ch,ld,_$('donutHashtagLegend'),h.slice(0,5),'mentions',x=>x.name,x=>x.size,x=>this._openHashtagPanel(x),'Hashtag')},
    async loadEngagement(type){const subMap={view:'postbyview',like:'postbylike',comment:'postbycomment'};const rows=parseInt(_$('rows-'+type)?.value||'100');const ls=_$('list-'+type);if(ls)ls.innerHTML=`<div class="spinner-state"><div class="spin-ring"></div>Memuat data…</div>`;try{const r=await fetch(`${API_BASE}/most-engagement?project_id=${OVCfg.pid}&start_date=${OVCfg.sd}&end_date=${OVCfg.ed}&sub=${subMap[type]}&rows=${rows}`);const j=await r.json();let items=j.data||j||[];if(!Array.isArray(items))items=[];Store[type]=items;Pag[type]=1;const ch=_$('chip-'+type);if(ch)ch.textContent=items.length;const bd=_$('badge-'+type);if(bd)bd.textContent=items.length+' videos';if(type==='view'&&!allPostsRaw.length)allPostsRaw=items;if(type==='view')this._updateKpi(items);this._renderList(type);this._renderDonut(type,items)}catch(e){console.error('[OV]',e);if(ls)ls.innerHTML=`<div class="chart-empty" style="padding:40px;"><i class="ph ph-warning"></i><span>Gagal memuat: ${esc(e.message)}</span></div>`;hideLd('loadingDonut-'+type)}},
    _updateKpi(items){let tv=0,tl=0,tc=0;items.forEach(i=>{tv+=parseInt(i.num_views||i.view_cnt||i.views||i.freq||0);tl+=parseInt(i.num_likes||i.likes||0);tc+=parseInt(i.num_comments||i.comments||0)});const n=items.length,av=v=>n?Math.round(v/n):0;const el=(id,v)=>{const e=_$(id);if(e)e.textContent=numF(v)};const sub=(id,v)=>{const e=_$(id);if(e)e.innerHTML=`<i class="ph ph-chart-line-up me-1"></i>Avg ${numF(av(v))} / video &middot; ${n} videos`};el('kpiViews',tv);sub('kpiViewsSub',tv);el('kpiLikes',tl);sub('kpiLikesSub',tl);el('kpiComments',tc);sub('kpiCommentsSub',tc);el('kpiEng',tv+tl+tc);const eS=_$('kpiEngSub');if(eS)eS.innerHTML=`<i class="ph ph-chart-bar me-1"></i>Views+Likes+Comments &middot; ${n} videos`},
    ...
    _metric(item,type){const k={view:['num_views','view_cnt','views','freq'],like:['num_likes','likes'],comment:['num_comments','comments']};return(k[type]||['view_cnt']).reduce((v,f)=>v||parseInt(item[f]||0),0)},
    ...
    _getColor(item){const seed=item.video_id||item.docid||item.id||this._getName(item)||'yt';const pal=['#038047','#273B4A','#F59E0B','#06B6D4','#8b5cf6','#ec4899','#f97316','#14b8a6'];let h=0;for(let i=0;i<seed.length;i++)h=(h*31+seed.charCodeAt(i))&0xffffffff;return pal[Math.abs(h)%pal.length]},
    ...
    _postHtml(item,gi,type){const rank=gi+1,rkC=rank<=3?'--'+rank:'',name=this._getName(item),color=this._getColor(item),avH=this._avHtml(item),sent=this._normSent(item);const content=dec((item.content||item.title||item.caption||'').replace(/<[^>]*>/g,'').replace(/\s+/g,' ').trim()).slice(0,200);const dt=(item.date_created||'').split('T')[0],url=item.url||item.link||'';const v=parseInt(item.num_views||item.view_cnt||item.views||item.freq||0),l=parseInt(item.num_likes||item.likes||0),c=parseInt(item.num_comments||item.comments||0),total=v+l+c;const sL={pos:'Positive',neg:'Negative',neu:'Neutral'}[sent],enc=encodeURIComponent(JSON.stringify(item));const vC=type==='view'?' tme-metric--primary':'',lC=type==='like'?' tme-metric--primary':'',cC=type==='comment'?' tme-metric--amber':'';const th=this._getThumb(item),thH=(th&&th.startsWith('http'))?`<div class="tme-post-thumb"><img src="${esc(th)}" loading="lazy" onerror="this.parentElement.innerHTML='<div class=\\'tme-post-thumb-ph\\'>🎬</div>'"><div class="tme-post-thumb-play"><i class="ph ph-play-fill"></i></div></div>`:`<div class="tme-post-thumb"><div class="tme-post-thumb-ph">🎬</div></div>`;return `<div class="tme-post" data-item="${esc(enc)}"><div class="tme-post-rank tme-post-rank${rkC}">${rank}</div><div class="tme-post-av" style="background:linear-gradient(135deg,${color},${color}99);">${avH}</div><div class="tme-post-body"><div class="tme-post-author">${esc(name)}</div>${dt?`<div class="tme-post-date">${dt}</div>`:''}${content?`<div class="tme-post-text">${esc(content)}</div>`:''}<div class="tme-post-stats"><span class="tme-metric${vC}"><i class="ph ph-eye me-1"></i>${numF(v)}</span><span class="tme-metric${lC}"><i class="ph ph-thumbs-up me-1"></i>${numF(l)}</span><span class="tme-metric${cC}"><i class="ph ph-chat-circle me-1"></i>${numF(c)}</span><span class="tme-metric" style="font-weight:800;">∑ ${numF(total)}</span><span class="tme-sent tme-sent--${sent}">${sL}</span>${url?`<a href="${esc(url)}" target="_blank" rel="noopener" class="tme-view-link" onclick="event.stopPropagation()"><i class="ph ph-arrow-square-out me-1"></i>Lihat</a>`:''}</div></div>${thH}</div>`},
    _renderDonut(type,items){const ld=_$('loadingDonut-'+type),ch=_$('donutChart-'+type),em=_$('donutEmpty-'+type),lg=_$('donutLegend-'+type);if(!ld||!ch)return;if(!items.length){ld.style.display='none';if(em)em.style.display='flex';return}const top5=items.slice(0,5),ml={view:'Views',like:'Likes',comment:'Comments'}[type];this._renderDonutEcharts(ch,ld,lg,top5,ml,it=>this._getName(it),it=>this._metric(it,type),it=>{OVPanel.open(Store[type],type,PLAT);OVDetail.open(it,type)},ml,it=>dec((it.content||it.title||'').replace(/<[^>]*>/g,'').replace(/\s+/g,' ').trim()))},
    _renderDonutEcharts(chartEl,loadEl,legEl,data,metricLabel,getNameFn,getValFn,onClickFn,titleLabel,getDescFn){if(!chartEl||!data.length){if(loadEl)loadEl.style.display='none';return}const total=data.reduce((s,d)=>s+getValFn(d),0);if(legEl)legEl.innerHTML=data.map((d,i)=>{const n=getNameFn(d),sn=n.length>22?n.slice(0,21)+'…':n;return `<div class="donut-leg-item"><span class="donut-dot" style="background:${DONUT_COLORS[i]};"></span>${sn} · ${numF(getValFn(d))}</div>`}).join('');if(loadEl)loadEl.style.display='none';chartEl.style.display='block';const ek='__ec_'+chartEl.id;if(window[ek]){try{window[ek].dispose()}catch(e){}}if(typeof echarts==='undefined'){chartEl.innerHTML='<div class="chart-empty"><i class="ph ph-chart-donut"></i><span>ECharts not loaded</span></div>';return}const chart=echarts.init(chartEl,null,{renderer:'canvas'});window[ek]=chart;window.addEventListener('resize',()=>{try{chart.resize()}catch(e){}});const pd=data.map((d,i)=>({name:getNameFn(d),value:getValFn(d),_desc:getDescFn?getDescFn(d):'',itemStyle:{color:DONUT_COLORS[i]}}));chart.setOption({backgroundColor:'transparent',animation:true,animationDuration:1000,animationEasing:'cubicOut',animationDelay:idx=>idx*80,tooltip:{show:false},series:[{type:'pie',radius:['38%','62%'],center:['50%','50%'],avoidLabelOverlap:true,selectedMode:false,minAngle:8,itemStyle:{borderColor:'#fff',borderWidth:3},label:{show:true,position:'outside',alignTo:'edge',edgeDistance:20,lineHeight:18,fontSize:11,fontFamily:'inherit',color:'#334155',fontWeight:'500',formatter:p=>{const d=data[p.dataIndex],desc=getDescFn?getDescFn(d).slice(0,80):'',words=desc?desc.split(' '):[],lines=[];let cur='';words.forEach(w=>{if((cur+' '+w).trim().length>40){lines.push(cur.trim());cur=w}else cur=(cur+' '+w).trim()});if(cur)lines.push(cur);const body=lines.join('\n');return `{title|${p.name}}\n${body?body+'\n':''}({val|${numF(p.value)}} ${metricLabel}, {pct|${p.percent.toFixed(1)}%})`},rich:{title:{fontSize:11,fontWeight:'700',color:'#1e293b',lineHeight:18},val:{fontSize:11,fontWeight:'700',color:'#038047'},pct:{fontSize:11,fontWeight:'600',color:'#64748b'}}},labelLine:{show:true,length:18,length2:24,smooth:0.3,lineStyle:{width:1.5,color:'#94A3B8'}},emphasis:{scale:false,itemStyle:{shadowBlur:0,shadowColor:'transparent',borderWidth:3,borderColor:'#fff',opacity:1},labelLine:{lineStyle:{width:2.5,color:'#273B4A'}},label:{show:true}},select:{disabled:true},data:pd}],graphic:[{type:'text',left:'center',top:'46%',z:100,style:{text:numK(total),fill:'#0f172a',font:"800 28px inherit",textAlign:'center'}},{type:'text',left:'center',top:'54%',z:100,style:{text:'TOTAL '+titleLabel.toUpperCase(),fill:'#94a3b8',font:"600 9px inherit",textAlign:'center'}}]});chart.on('click',p=>{const d=data[p.dataIndex];if(d&&onClickFn)onClickFn(d)});let _tt=document.getElementById('ovCustomTT');if(!_tt){_tt=document.createElement('div');_tt.id='ovCustomTT';_tt.style.cssText='position:fixed;z-index:9999;pointer-events:none;background:#1e293b;color:#fff;border:1px solid #334155;border-radius:6px;padding:10px 14px;max-width:280px;font-size:12px;line-height:1.5;display:none;box-shadow:0 8px 24px rgba(0,0,0,.32);font-family:inherit;opacity:0;transform:translateY(6px) scale(.97);transition:opacity .18s ease,transform .18s ease;';document.body.appendChild(_tt)}let _tm=null;chart.on('mouseover',p=>{if(p.componentType!=='series')return;const d=data[p.dataIndex],cl=DONUT_COLORS[p.dataIndex],desc=(getDescFn?getDescFn(d):'').slice(0,160);clearTimeout(_tm);_tt.innerHTML=`<div style="display:flex;align-items:center;gap:6px;margin-bottom:5px;"><span style="width:9px;height:9px;border-radius:50%;background:${cl};flex-shrink:0;display:inline-block;"></span><b style="font-size:12.5px;">${esc(p.name)}</b></div>${desc?`<div style="font-size:11px;color:#94a3b8;margin-bottom:6px;">${esc(desc)}</div>`:''}<div style="display:flex;align-items:center;gap:8px;"><b style="font-size:13px;">${numF(p.value)} ${metricLabel}</b><span style="color:${cl};font-weight:700;">${p.percent.toFixed(1)}%</span></div>`;_tt.style.display='block';requestAnimationFrame(()=>{_tt.style.opacity='1';_tt.style.transform='translateY(0) scale(1)'})});chart.on('mouseout',()=>{_tt.style.opacity='0';_tt.style.transform='translateY(6px) scale(.97)';_tm=setTimeout(()=>{_tt.style.display='none'},180)});chartEl.addEventListener('mousemove',e=>{if(_tt.style.display==='none')return;const vw=window.innerWidth,vh=window.innerHeight,tw=_tt.offsetWidth+16,th=_tt.offsetHeight+16;let x=e.clientX+18,y=e.clientY-10;if(x+tw>vw)x=e.clientX-tw;if(y+th>vh)y=e.clientY-th;_tt.style.left=x+'px';_tt.style.top=y+'px'})},
    _openHashtagPanel(h){const tag='#'+h.name.toLowerCase();const filtered=allPostsRaw.filter(p=>(p.content||p.title||p.caption||'').toLowerCase().includes(tag));OVPanel.open(filtered.length?filtered:allPostsRaw.slice(0,20),'view',`${PLAT} — #${h.name} (${h.size} mentions)`)},
};

/* ── PANEL ── */
const OVPanel={_items:[],_type:null,open(items,type,title){this._items=items||[];this._type=type;OVDetail.close();_$('ovPanelDot').style.background=OVCfg.colors[type]||OVCfg.primary;_$('ovPanelTitle').textContent=title||PLAT+' Videos';_$('ovPanelMeta').textContent=OVCfg.sd+' – '+OVCfg.ed;const ov=_$('ovPanelOverlay'),pn=_$('ovSntPanel');ov.classList.remove('hiding');pn.classList.remove('hiding');ov.classList.add('show');pn.classList.add('show');this._render(items,type)},close(){OVDetail.killIframe();OVDetail.close();const ov=_$('ovPanelOverlay'),pn=_$('ovSntPanel');pn.classList.add('hiding');ov.classList.add('hiding');setTimeout(()=>{pn.classList.remove('show','hiding');ov.classList.remove('show','hiding')},240)},_render(items,type){const list=_$('ovPanelList');if(!list)return;if(!items?.length){list.innerHTML='<div class="do-panel-loading"><div class="do-panel-spinner"></div>Tidak ada data</div>';return}const ml={view:'Views',like:'Likes',comment:'Komentar'}[type]||'Views';list.innerHTML=items.slice(0,100).map(item=>{const nm=OVData._getName(item),av=OVData._getAvatar(item),cl=OVData._getColor(item),d='/assets/images/user/dummy.jpg',aH=(av&&av.startsWith('http'))?`<img src="${esc(av)}" onerror="this.src='${d}'">`:`<img src="${d}">`,tx=(item.content||item.title||'').replace(/<[^>]*>/g,'').trim(),mv=OVData._metric(item,type),dt=(item.date_created||'').split('T')[0],sn=OVData._normSent(item),sl={pos:'Pos',neg:'Neg',neu:'Neu'}[sn],v=parseInt(item.num_views||item.view_cnt||0),l=parseInt(item.num_likes||item.likes||0),c=parseInt(item.num_comments||item.comments||0),total=v+l+c,enc=encodeURIComponent(JSON.stringify(item));return `<div class="do-panel-item" data-item="${esc(enc)}" data-type="${type}" onclick="OVPanel._click(this)"><div class="do-panel-avatar" style="background:linear-gradient(135deg,${cl},${cl}99);">${aH}</div><div class="do-panel-item-body"><div class="do-panel-author">${esc(nm)}</div><div class="do-panel-text">${esc(dec(tx).slice(0,130)||'(tidak ada konten)')}</div><div class="do-panel-footer"><span class="do-sent-badge do-sent-badge--${sn}">${sl}</span><span>${ml} ${numF(mv)}</span><span>∑ ${numF(total)}</span>${dt?`<span style="margin-left:auto;">${dt}</span>`:''}</div></div></div>`}).join('');if(items.length>100)list.insertAdjacentHTML('beforeend',`<div style="padding:8px;text-align:center;font-size:10px;font-weight:600;color:#94A3B8;background:var(--slate-50);border-top:1px dashed var(--slate-200);">+${(items.length-100).toLocaleString()} lainnya</div>`)},_click(el){try{const item=JSON.parse(decodeURIComponent(el.dataset.item.replace(/&amp;/g,'&').replace(/&lt;/g,'<').replace(/&gt;/g,'>').replace(/&quot;/g,'"')));OVDetail.open(item,el.dataset.type||this._type)}catch(e){console.warn(e)}}};

/* ── DETAIL ── */
const OVDetail={open(item,type){const panel=_$('ovDetailPanel'),body=_$('ovDetailBody'),title=_$('ovDetailTitle');if(!panel||!body)return;const color=OVCfg.colors[type]||OVCfg.primary,name=OVData._getName(item),av=OVData._getAvatar(item),ac=OVData._getColor(item),d='/assets/images/user/dummy.jpg',aH=(av&&av.startsWith('http'))?`<img src="${esc(av)}" onerror="this.src='${d}'">`:`<img src="${d}">`;const handle=item.author_scr_name||item.channel_name||'';const raw=(item.content||item.title||item.caption||'').replace(/<[^>]*>/g,'').trim(),ct=raw?dec(raw):'',url=item.url||item.link||'',dt=item.date_created||'';const v=parseInt(item.num_views||item.view_cnt||item.views||item.freq||0),l=parseInt(item.num_likes||item.likes||0),c=parseInt(item.num_comments||item.comments||0);const sn=OVData._normSent(item),sl={pos:'Positif',neg:'Negatif',neu:'Netral'}[sn];let dtF='';if(dt)try{dtF=new Date(dt).toLocaleDateString('id-ID',{weekday:'long',day:'2-digit',month:'long',year:'numeric',hour:'2-digit',minute:'2-digit'})}catch(e){dtF=dt.split('T')[0]}let vid=item.video_id||item.docid||'';if(!vid&&url){const m=url.match(/(?:v=|\/embed\/|youtu\.be\/)([a-zA-Z0-9_-]{11})/);if(m)vid=m[1]}const mH=vid?`<div class="do-dp2-media"><iframe src="https://www.youtube.com/embed/${esc(vid)}" allow="autoplay;encrypted-media" allowfullscreen></iframe></div>`:'';title.textContent=name;body.innerHTML=`<div class="do-dp2-avatar-row"><div class="do-dp2-avatar-lg" style="background:linear-gradient(135deg,${ac},${ac}99);">${aH}</div><div><div class="do-dp2-name">${esc(name)}</div>${handle?`<div class="do-dp2-handle">${esc(handle)}</div>`:''}<span class="do-dp2-plat-badge" style="background:${color}18;color:${color};">YouTube</span></div></div>${dtF?`<div class="do-dp2-meta">${dtF}</div>`:''}<div class="do-dp2-sent do-dp2-sent--${sn}">${sl}</div>${mH}${ct?`<div class="do-dp2-content">${esc(ct)}</div>`:''}<div class="do-dp2-stats"><div class="do-dp2-stat"><div class="do-dp2-stat-val">${numF(v)}</div><div class="do-dp2-stat-lbl">Views</div></div><div class="do-dp2-stat"><div class="do-dp2-stat-val">${numF(l)}</div><div class="do-dp2-stat-lbl">Likes</div></div><div class="do-dp2-stat"><div class="do-dp2-stat-val">${numF(c)}</div><div class="do-dp2-stat-lbl">Comments</div></div></div>${url?`<a href="${esc(url)}" target="_blank" rel="noopener noreferrer" class="do-dp2-link"><i class="ph ph-arrow-square-out me-1"></i>Buka di YouTube</a>`:''}`;panel.classList.add('show')},close(){_$('ovDetailPanel')?.classList.remove('show')},killIframe(){const b=_$('ovDetailBody');if(b)b.querySelectorAll('iframe').forEach(f=>{f.src='';f.remove()})}};

/* ══════════════════════════════════════════════════════
   EXPORT MODULE — YTExport
   Full-page: KPI + tab aktif | Per-card: tiap card
══════════════════════════════════════════════════════ */
const YTExport = (() => {
    ...
    /* Resize semua ECharts instance (key pattern: __ec_{id}) */
    function _syncCharts(){
        Object.keys(window).filter(k=>k.startsWith('__ec_')).forEach(k=>{ try{ window[k].resize(); }catch(e){} });
    ...
    /* ── Paginate canvas across PDF pages ── */
    ...
    async function _exportPdf(){
        ...
        _drawHeader(pdf,pdf.internal.pageSize.getWidth(),10,'YouTube Overview');
        _paginate(canvas,pdf,'YouTube Overview');
        const stamp=new Date().toISOString().slice(0,10).replace(/-/g,'');
        pdf.save(`youtube_overview_${OVCfg.pid}_${stamp}.pdf`);
    }

    async function _exportImage(){
        const canvas=await _capture();
        const stamp=new Date().toISOString().slice(0,10).replace(/-/g,'');
        const link=document.createElement('a'); link.download=`youtube_overview_${OVCfg.pid}_${stamp}.png`; link.href=canvas.toDataURL('image/png'); link.click();
    }
    ...
    async function _captureCard(areaId,cardKey){
        ...
        /* sync ECharts for this card */
        const ecId=_ecIdForCard(cardKey);
        if(ecId&&window['__ec_'+ecId]){ try{ window['__ec_'+ecId].resize(); }catch(e){} }
    ...
    /* Map card key → ECharts element id (prefix __ec_) */
    function _ecIdForCard(k){
        const m={
            'hashtag-donut' : 'donutHashtagChart',
            'donut-view'    : 'donutChart-view',
            'donut-like'    : 'donutChart-like',
            'donut-comment' : 'donutChart-comment',
        };
        return m[k]||null;
    }

    /* Card metadata: label for PDF header, file prefix for filename */
    const _meta = {
    ...
    const _label    = k => (_meta[k]||{label:k}).label;
    const _filename = k => { const f=(_meta[k]||{file:k}).file; const s=new Date().toISOString().slice(0,10).replace(/-/g,''); return `youtube_overview_${f}_${OVCfg.pid}_${s}`; };

    /* ── Public: run card export ── */
    async function runCard(areaId,cardKey,type,btn){
        ...
        try{
            const canvas=await _captureCard(areaId,cardKey),fname=_filename(cardKey);
            if(type==='image'){
                ...
                _drawHeader(pdf,pdf.internal.pageSize.getWidth(),10,_label(cardKey));
                _paginate(canvas,pdf,_label(cardKey));
                pdf.save(fname+'.pdf'); _toast('PDF berhasil diunduh!','success');
            }
        } catch(err){ console.error('[YTExport.runCard]',err); _toast('Export gagal: '+err.message,'error'); }
        finally{ _btnState(btn,false); }
    }

    /* ── Public: run full-page export ── */
    async function run(type,btn){
        ...
        } catch(err){ console.error('[YTExport]',err); _toast('Export gagal: '+err.message,'error'); }
