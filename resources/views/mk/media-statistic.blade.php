...
const MSDetail = {
  ...
  open(item,platform){
    ...
    let sourceBtnHtml = '';
    if (platform === 'doc') {
        /* For doc items, check article URL */
        ...
        if (docSourceUrl) {
            sourceBtnHtml = `<a href="${esc(docSourceUrl)}" target="_blank" rel="noopener noreferrer" class="do-dp2-link" style="background:#0284c7;"><i class="ph ph-newspaper"></i> Baca Artikel Asli</a>`;
        } else {
