...
const XExport = (() => {
    ...
    async function _capture() {
        ...
        /* Resize ECharts donut agar canvas up-to-date */
        const donutEl = _$('donutChart');
        if (donutEl && typeof echarts !== 'undefined') {
            try { echarts.getInstanceByDom(donutEl)?.resize(); } catch(e) {}
        }
    ...
    async function _exportPdf() {
        ...
        const margin = 10;
        _drawPdfHeader(pdf, pW, margin, 'X Most Retweets');
