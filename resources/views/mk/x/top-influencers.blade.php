...
{{-- Content: Donut compact top, Full-width list below --}}
<div class="row">
    <div class="col-lg-6 col-12"><div class="card mb-3" style="animation:fadeUp .38s ease-out .18s both;"><div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2"><div class="d-flex align-items-center gap-2"><div class="avtar avtar-xs bg-light-primary rounded"><i class="ph ph-chart-donut f-18 text-primary"></i></div><div><h6 class="mb-0">Top 5 Engagement Share</h6><small class="text-muted">Klik untuk lihat detail</small></div></div></div><div class="card-body"><div class="chart-container" style="height:300px;"><div class="chart-loading" id="loadingDonut"><div class="spin-ring"></div><span>Loading…</span></div><div id="donutChart" style="width:100%;height:300px;display:none;"></div><div id="donutEmpty" style="display:none;" class="chart-empty"><i class="ph ph-chart-donut"></i><span>No data</span></div></div></div></div></div>
    <div class="col-lg-6 col-12"><div class="card mb-3" style="animation:fadeUp .38s ease-out .22s both;"><div class="card-header d-flex align-items-center gap-2"><div class="avtar avtar-xs bg-light-primary rounded"><i class="ph ph-list-bullets f-18 text-primary"></i></div><div><h6 class="mb-0">Top 5 Legend</h6><small class="text-muted">Engagement breakdown</small></div></div><div class="card-body"><div id="donutLegend" class="donut-legend" style="flex-direction:column;gap:10px;"></div></div></div></div>
</div>
<div class="row">
    <div class="col-12"><div class="card mb-3" style="animation:fadeUp .38s ease-out .26s both;"><div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2"><div class="d-flex align-items-center gap-2"><div class="avtar avtar-xs bg-light-primary rounded"><i class="ph ph-star f-18 text-primary"></i></div><div><h6 class="mb-0">Influencer Ranking</h6><small class="text-muted">Klik user untuk lihat profil</small></div></div><div class="d-flex align-items-center gap-2"><button class="btn btn-outline-secondary btn-sm" onclick="exportCsv()" title="Export CSV"><i class="ph ph-download-simple me-1"></i>CSV</button><span class="badge bg-light-primary text-primary" id="badgeTotal">Loading…</span></div></div><div id="userList" class="p-0"><div class="spinner-state"><div class="spin-ring"></div>Memuat data…</div></div><div id="pagArea"></div></div></div>
</div>
{{-- Slide Panel --}}
