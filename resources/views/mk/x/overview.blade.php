...
.spin-ring {
    ...
    min-width: 28px;
    min-height: 28px;
    border: 3px solid rgba(3, 128, 71, 0.15);
...
.do-panel-spinner{display:block;width:28px;height:28px;min-width:28px;min-height:28px;border:2.5px solid var(--slate-100);border-top-color:var(--primary);border-radius:50%;animation:spin .65s linear infinite;flex-shrink: 0;aspect-ratio: 1/1;box-sizing: border-box;}
