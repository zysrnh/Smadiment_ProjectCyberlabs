...
@section('title', 'X Most Active Users - SMADIMENT')
...
.ht-bar-wrap{flex:0 0 60px;height:6px;background:var(--slate-100);border-radius:99px;overflow:hidden}.ht-bar-fill{height:100%;border-radius:99px;background:linear-gradient(90deg,#0D9488,rgba(13,148,136,.5));transition:width .4s cubic-bezier(.4,0,.2,1)}.ht-count{font-size:11px;font-weight:700;color:var(--slate-500);white-space:nowrap;flex-shrink:0;min-width:36px;text-align:right}
...
.up-tw-head{display:flex;align-items:center;gap:8px;margin-bottom:6px}.up-tw-mav{width:28px;height:28px;border-radius:50%;object-fit:cover;border:1px solid var(--slate-200);flex-shrink:0}.up-tw-author{font-size:12px;font-weight:700;color:var(--slate-900)}.up-tw-time{font-size:10px;color:var(--slate-400);margin-left:auto}
...
{{-- KPI --}}
<div class="row mb-3">
    <div class="col-md-6 col-xl-3"><div class="card h-100 text-white kpi-card-hover fade-up fade-up-d1" style="background:linear-gradient(135deg,#0D9488,#14B8A6)"><div class="card-body"><div class="d-flex align-items-center"><div class="flex-grow-1"><p class="mb-1 text-white text-opacity-75 f-12">Total Users</p><h3 class="mb-0 text-white f-w-300" id="kpiUsers"><span class="sk-block" style="width:80px;height:24px;display:inline-block;"></span></h3><p class="mb-0 mt-2 text-white text-opacity-75 f-12" id="kpiUsersSub"><i class="ph ph-users me-1"></i>Loading…</p></div><div class="flex-shrink-0 ms-3"><div class="kpi-icon-bg"><i class="ph ph-users"></i></div></div></div></div></div></div>
    <div class="col-md-6 col-xl-3"><div class="card h-100 text-white kpi-card-hover fade-up fade-up-d2" style="background:linear-gradient(135deg,#059669,#10B981)"><div class="card-body"><div class="d-flex align-items-center"><div class="flex-grow-1"><p class="mb-1 text-white text-opacity-75 f-12">Total Engagement</p><h3 class="mb-0 text-white f-w-300" id="kpiEng"><span class="sk-block" style="width:80px;height:24px;display:inline-block;"></span></h3><p class="mb-0 mt-2 text-white text-opacity-75 f-12" id="kpiEngSub"><i class="ph ph-chart-bar me-1"></i>Loading…</p></div><div class="flex-shrink-0 ms-3"><div class="kpi-icon-bg"><i class="ph ph-chart-bar"></i></div></div></div></div></div></div>
    <div class="col-md-6 col-xl-3"><div class="card h-100 text-white kpi-card-hover fade-up fade-up-d3" style="background:linear-gradient(135deg,#0891B2,#06B6D4)"><div class="card-body"><div class="d-flex align-items-center"><div class="flex-grow-1"><p class="mb-1 text-white text-opacity-75 f-12">Avg. Engagement</p><h3 class="mb-0 text-white f-w-300" id="kpiAvg"><span class="sk-block" style="width:80px;height:24px;display:inline-block;"></span></h3><p class="mb-0 mt-2 text-white text-opacity-75 f-12" id="kpiAvgSub"><i class="ph ph-trend-up me-1"></i>Loading…</p></div><div class="flex-shrink-0 ms-3"><div class="kpi-icon-bg"><i class="ph ph-trend-up"></i></div></div></div></div></div></div>
    <div class="col-md-6 col-xl-3"><div class="card h-100 text-white kpi-card-hover fade-up fade-up-d4" style="background:linear-gradient(135deg,#D97706,#F59E0B)"><div class="card-body"><div class="d-flex align-items-center"><div class="flex-grow-1"><p class="mb-1 text-white text-opacity-75 f-12">Most Active</p><h3 class="mb-0 text-white f-w-300" id="kpiTop" style="font-size:1rem;"><span class="sk-block" style="width:80px;height:24px;display:inline-block;"></span></h3><p class="mb-0 mt-2 text-white text-opacity-75 f-12" id="kpiTopSub"><i class="ph ph-trophy me-1"></i>Loading…</p></div><div class="flex-shrink-0 ms-3"><div class="kpi-icon-bg"><i class="ph ph-trophy"></i></div></div></div></div></div></div>
</div>
{{-- Content --}}
<div class="row">
    <div class="col-lg-5 col-12"><div class="card mb-3" style="animation:fadeUp .38s ease-out .18s both;"><div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2"><div class="d-flex align-items-center gap-2"><div class="avtar avtar-xs bg-light-primary rounded"><i class="ph ph-chart-donut f-18 text-primary"></i></div><div><h6 class="mb-0">Top 5 User Engagement</h6><small class="text-muted">Klik untuk lihat detail</small></div></div><div id="donutLegend" class="donut-legend"></div></div><div class="card-body"><div class="chart-container" style="height:400px;"><div class="chart-loading" id="loadingDonut"><div class="spin-ring"></div><span>Loading…</span></div><div id="donutChart" style="width:100%;height:400px;display:none;"></div><div id="donutEmpty" style="display:none;" class="chart-empty"><i class="ph ph-chart-donut"></i><span>No data</span></div></div></div></div></div>
    <div class="col-lg-7 col-12"><div class="card mb-3" style="animation:fadeUp .38s ease-out .22s both;"><div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2"><div class="d-flex align-items-center gap-2"><div class="avtar avtar-xs bg-light-primary rounded"><i class="ph ph-users f-18 text-primary"></i></div><div><h6 class="mb-0">Ranked Users by Activity</h6><small class="text-muted">Klik user untuk lihat detail</small></div></div><div class="d-flex align-items-center gap-2"><button class="btn btn-outline-secondary btn-sm" onclick="exportCsv()" title="Export CSV"><i class="ph ph-download-simple me-1"></i>CSV</button><span class="badge bg-light-primary text-primary" id="badgeTotal">Loading…</span></div></div><div id="userList" class="p-0"><div class="spinner-state"><div class="spin-ring"></div>Memuat data…</div></div><div id="pagArea"></div></div></div>
</div>
{{-- Slide Panel --}}
...
const DONUT_COLORS=['#0D9488','#059669','#0891B2','#D97706','#F43F5E'];
...
const _avUrl=u=>{const a=u.profile_image_url||u.avatar||'';return a?a:((u.username)?`https://unavatar.io/twitter/${u.username}`:'')};
let Store=[],curPage=1;const PP=15;let donutInst=null;
/* load data */
async function loadData(){
    try{
        const r=await fetch(`/mk/api/x/most-active-users?project_id=${CFG.pid}&start_date=${CFG.sd}&end_date=${CFG.ed}`);
        const j=await r.json();
        let rows=null;
        if(Array.isArray(j?.data?.data))rows=j.data.data;
        else if(Array.isArray(j?.data?.users))rows=j.data.users;
        else if(Array.isArray(j?.data?.items))rows=j.data.items;
        else if(Array.isArray(j?.data))rows=j.data;
        else if(Array.isArray(j?.users))rows=j.users;
        else if(Array.isArray(j))rows=j;
        else if(j?.data&&typeof j.data==='object'){const v=Object.values(j.data);if(v.length>0&&typeof v[0]==='object')rows=v;}
        if(!rows||!rows.length){showEmpty();return}
        Store=rows.sort((a,b)=>eng(b)-eng(a));
        curPage=1;updateKpi();renderDonut();renderList();
    }catch(e){console.error(e);showEmpty()}
}
function showEmpty(){_$('loadingDonut').style.display='none';_$('donutEmpty').style.display='flex';_$('userList').innerHTML='<div class="spinner-state" style="padding:40px;"><i class="ph ph-users" style="font-size:32px;color:var(--slate-300);"></i><span>Tidak ada data user</span></div>';['kpiUsers','kpiEng','kpiAvg'].forEach(i=>{const e=_$(i);if(e)e.textContent='0'});_$('kpiTop').textContent='–';_$('badgeTotal').textContent='0 users'}
function updateKpi(){
    const n=Store.length,tot=Store.reduce((s,u)=>s+eng(u),0),avg=n?Math.round(tot/n):0,top=Store[0];
    _$('kpiUsers').textContent=numF(n);_$('kpiUsersSub').innerHTML=`<i class="ph ph-users me-1"></i>${n} tracked users`;
    _$('kpiEng').textContent=numF(tot);_$('kpiEngSub').innerHTML=`<i class="ph ph-chart-bar me-1"></i>Total interactions`;
    _$('kpiAvg').textContent=numF(avg);_$('kpiAvgSub').innerHTML=`<i class="ph ph-trend-up me-1"></i>Per user`;
    if(top){_$('kpiTop').textContent=top.name||top.username||'–';_$('kpiTopSub').innerHTML=`<i class="ph ph-trophy me-1"></i>${numF(eng(top))} engagement`}
    _$('badgeTotal').textContent=n+' users';
}
/* donut */
function renderDonut(){
    ...
    const data=top5.map((u,i)=>({name:u.name||u.username||'User',value:eng(u),uname:u.username||'',itemStyle:{color:DONUT_COLORS[i],borderColor:'#fff',borderWidth:3}}));
    ...
    donutInst.on('click',p=>{if(p.componentType==='series'){const u=top5.find(x=>(x.name||x.username)===p.name);if(u)Panel.open(u)}});
    window.addEventListener('resize',()=>{try{donutInst.resize()}catch(e){}});
    lg.innerHTML=top5.map((u,i)=>`<span class="donut-leg-item" onclick="Panel.open(Store[${i}])"><span class="donut-dot" style="background:${DONUT_COLORS[i]}"></span>${esc((u.name||u.username||'').substring(0,15))}</span>`).join('');
}
/* user list */
function renderList(){
    ...
    const total=Store.length,pages=Math.ceil(total/PP),start=(curPage-1)*PP,items=Store.slice(start,start+PP),mx=Store[0]?eng(Store[0]):1;
    let h='<div class="ht-list">';
    items.forEach((u,i)=>{
        const rk=start+i+1,rc=rk<=3?` ht-rank--${rk}`:'',pct=Math.round((eng(u)/mx)*100);
        const src=_avUrl(u),init=_getInit(u.name||u.username||'');
        ...
        h+=`<div class="ht-item" onclick="Panel.open(Store[${start+i}])"><div class="ht-rank${rc}">${rk}</div><div class="ht-av">${avH}</div><div class="ht-info"><div class="ht-name">${esc(u.name||u.username||'Unknown')}</div><div class="ht-handle">@${esc(u.username||'')}</div></div><div class="ht-bar-wrap"><div class="ht-bar-fill" style="width:${pct}%;"></div></div><div class="ht-count">${numF(eng(u))}</div></div>`;
    });
...
const Panel=(()=>{
    ...
    function open(user){
        ...
        _$('panelTitle').textContent=(user.name||user.username||'User')+' — Profile';
    ...
    async function _fetchMentions(){
        try{
            const url=`/mk/api/x/user-detailed-mentions?project_id=${CFG.pid}&username=${encodeURIComponent(_u.username||'')}&start_date=${CFG.sd}&end_date=${CFG.ed}&api_start=${_apiStart}&stat_mentions=${_u.mentions||0}&stat_replies=${_u.replies||0}&stat_retweets=${_u.retweets||0}`;
    ...
    function _profileHTML(u){
        const name=u.name||u.username||'Unknown',uname=u.username||'',src=_avUrl(u),init=_getInit(name);
        const fol=parseInt(u.followers||0),men=parseInt(u.mentions||0),rep=parseInt(u.replies||0),rt=parseInt(u.retweets||0),tot=men+rep+rt;
        ...
        return `<div class="up-banner"></div><div class="up-profile"><div style="display:flex;align-items:flex-end;justify-content:space-between;gap:10px">${avH}<a href="https://twitter.com/${esc(uname)}" target="_blank" rel="noopener" style="font-size:11px;font-weight:700;color:#fff;background:#0f1419;padding:6px 14px;border-radius:99px;text-decoration:none;display:inline-flex;align-items:center;gap:5px;margin-bottom:4px"><i class="ph ph-arrow-square-out" style="font-size:12px"></i>View on X</a></div><div class="up-name">${esc(name)}</div><div class="up-handle"><a href="https://twitter.com/${esc(uname)}" target="_blank" rel="noopener">@${esc(uname)}</a> · <strong>${numF(fol)}</strong> Followers</div><div class="up-stats"><div class="up-stat"><div class="up-stat-val">${numF(men)}</div><div class="up-stat-lbl">Mentions</div></div><div class="up-stat"><div class="up-stat-val">${numF(rep)}</div><div class="up-stat-lbl">Replies</div></div><div class="up-stat"><div class="up-stat-val">${numF(rt)}</div><div class="up-stat-lbl">Retweets</div></div></div><div class="up-total"><span class="up-total-lbl"><i class="ph ph-chart-bar"></i> Total Engagement</span><span class="up-total-val">${numF(tot)}</span></div></div>`;
    }
    ...
    function _tweetCard(m){
        ...
        const author=m.author_name||m.author||_u?.username||'',handle=m.author||_u?.username||'';
