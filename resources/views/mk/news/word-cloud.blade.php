...
<div class="row mb-3">
  <div class="col-md-4">
    <div class="card h-100 text-white fade-up fade-up-d1" style="background:#4680ff;">
      <div class="card-body">
  ...
  <div class="col-md-4">
    <div class="card h-100 text-white fade-up fade-up-d2" style="background:#10B981;">
      <div class="card-body">
        <div class="d-flex align-items-center">
          <div class="flex-grow-1">
  ...
  <div class="col-md-4">
    <div class="card h-100 text-white fade-up fade-up-d3" style="background:#F59E0B;">
      <div class="card-body">
        <div class="d-flex align-items-center">
          <div class="flex-grow-1">
...
@section('scripts')
  ...
  /* ════════════════════════════════════════════════════════
   EXPORT MODULE — Word Cloud (FIXED)
════════════════════════════════════════════════════════ */
const WCExport = (() => {
    const _urlP     = new URLSearchParams(window.location.search);
    ...
    function _freezeAnimations() {
        ...
        _freezeStyle.textContent = `
            *, *::before, *::after {
            ...
            /* Paksa semua elemen visible (fix fadeUp opacity:0) */
    ...
    async function _capture() {
        ...
        /* 2. Freeze semua animasi */
        _freezeAnimations();

        /* 3. Resize chart */
        _resizeAll();

        /* 4. Tunggu browser selesai repaint */
        ...
        try {
            const canvas = await html2canvas(area, {
                ...
                onclone         : (clonedDoc) => {
                    ...
                    ['pageExportPdfBtn','pageExportImgBtn'].forEach(id => {
            ...
            /* 5. Unfreeze animasi setelah capture selesai */
            _unfreezeAnimations();
        }
    }
