    ...
    <script>
        ...
        const TikTokExport = (() => {
            ...
            async function _capture() {
                ...
                /* Scroll ke atas + tunggu chart ECharts selesai render */
                window.scrollTo({ top: 0 });
                await new Promise(r => setTimeout(r, 300));

                /* Resize semua ECharts agar canvas-nya up-to-date */
            ...
            async function _exportPdf() {
                ...
                const _drawHeader = (doc) => {
                    doc.setFillColor(3, 128, 71);   /* --primary green */
                    doc.rect(0, 0, pW, 11, 'F');
                    doc.setTextColor(255, 255, 255);
                    doc.setFontSize(9); doc.setFont('helvetica','bold');
                    doc.text('SMADIMENT — TikTok Emotion Analysis', margin, 7.5);
            ...
            async function _captureCard(areaId, cardKey) {
                ...
                /* Resize ECharts instances that live inside this card */
            ...
            function _cardFilename(cardKey) {
                ...
                const stamp = new Date().toISOString().slice(0,10).replace(/-/g,'');
                return `tiktok_${labels[cardKey]||cardKey}_${FEA_PID}_${stamp}`;
            }
            ...
            async function run(type, btn) {
                ...
                try {
                    ...
                    console.error('[TikTokExport]', err);
                    _toast('Export gagal: '+err.message, 'error');
                } finally {
