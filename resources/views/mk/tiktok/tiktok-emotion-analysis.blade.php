...
async function _doCapture(el, isCard) {
    ...
    // Freeze animasi CSS (perlu untuk Chrome & Safari)
    ...
    // Freeze CSS animations
    if (!document.getElementById('__ig_freeze')) {
        const s = document.createElement('style');
        s.id = '__ig_freeze';
        s.textContent = '*{animation:none!important;transition:none!important;animation-play-state:paused!important;}';
        document.head.appendChild(s);
    ...
    // Minimal delay — swap sudah selesai, animasi sudah difreeze
    ...
    try {
        ...
        // Unfreeze & restore charts
        document.getElementById('__ig_freeze')?.remove();
