...
@section('styles')
    ...
    ══════════════════════════════════════════════════════ */
        ...
        /* ══ Tabs ══ */
        .fea-tabs {
            display: flex; gap: 2px; background: var(--slate-100);
        ...
        .fea-tab-btn {
            ...
            gap: 6px; padding: 7px 12px; border-radius: 4px; border: none;
        ...
        .fea-tab-chip {
            ...
            min-width: 20px; height: 16px; padding: 0 5px; border-radius: 3px;
        ...
        .fea-toggle-btn {
            ...
            color: var(--slate-500); cursor: pointer; transition: background .12s, color .12s;
        }
        ...
        .fea-emo-badge {
            ...
            font-size: 9px; font-weight: 800; text-transform: capitalize; border: 1px solid transparent;
        }
        ...
        .fea-view-link {
            ...
            color: var(--primary); text-decoration: none; padding: 2px 6px; border-radius: 3px;
        ...
        .fea-post-thumb-play { position: absolute; inset: 0; display: flex; align-items: center; justify-content: center; background: rgba(0,0,0,.28); opacity: 0; transition: opacity .2s; border-radius: inherit; }
        ...
        .fea-pag-btn {
            ...
            justify-content: center; padding: 0 6px; border-radius: var(--radius-sm);
            border: 1px solid var(--slate-200); background: #fff; font-size: 11px;
            font-weight: 600; color: var(--slate-500); cursor: pointer;
        ...
        .donut-leg-item {
            ...
            color: var(--slate-500); padding: 3px 8px; background: var(--slate-50);
            border-radius: 3px; border: 1px solid var(--slate-200); cursor: pointer;
        ...
        .do-dp2-sent {
            ...
            border-radius: 3px; font-size: 11px; font-weight: 700; margin-bottom: 10px;
        }
        ...
        <div class="page-export-bar" data-html2canvas-ignore="true">
            ...
            <div class="page-export-bar-right">
                <button type="button"
                        ...
                        id="pageExportPdfBtn"
                        onclick="TikTokExport.run('pdf', this)"
                ...
                <button type="button"
                        ...
                        id="pageExportImgBtn"
                        onclick="TikTokExport.run('image', this)"
                    ...
                    <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                        ...
                        <div class="d-flex align-items-center gap-2 flex-wrap">
                            ...
                            <div class="d-flex gap-1" data-html2canvas-ignore="true">
                                <button class="card-exp-btn card-exp-btn-pdf" onclick="TikTokExport.runCard('card-export-donut','donut','pdf',this)" title="Export PDF"><i class="ph ph-file-pdf export-icon"></i><span class="export-spinner"></span></button>
                                <button class="card-exp-btn card-exp-btn-img" onclick="TikTokExport.runCard('card-export-donut','donut','image',this)" title="Export PNG"><i class="ph ph-image export-icon"></i><span class="export-spinner"></span></button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex align-items-center gap-1">
                            ...
                            <div data-html2canvas-ignore="true" class="d-flex gap-1">
                                <button class="card-exp-btn card-exp-btn-pdf" onclick="TikTokExport.runCard('card-export-radar','radar','pdf',this)" title="Export PDF"><i class="ph ph-file-pdf export-icon"></i><span class="export-spinner"></span></button>
                                <button class="card-exp-btn card-exp-btn-img" onclick="TikTokExport.runCard('card-export-radar','radar','image',this)" title="Export PNG"><i class="ph ph-image export-icon"></i><span class="export-spinner"></span></button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                ...
                <div class="card" style="animation:fadeUp .38s ease-out .22s both;">
                    ...
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex align-items-center gap-1">
                            ...
                            <div data-html2canvas-ignore="true" class="d-flex gap-1">
                                <button class="card-exp-btn card-exp-btn-pdf" onclick="TikTokExport.runCard('card-export-bar','bar','pdf',this)" title="Export PDF"><i class="ph ph-file-pdf export-icon"></i><span class="export-spinner"></span></button>
                                <button class="card-exp-btn card-exp-btn-img" onclick="TikTokExport.runCard('card-export-bar','bar','image',this)" title="Export PNG"><i class="ph ph-image export-icon"></i><span class="export-spinner"></span></button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                ...
                <div class="card" style="animation:fadeUp .38s ease-out .24s both;">
                    ...
                    <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div data-html2canvas-ignore="true" class="d-flex gap-1">
                                <button class="card-exp-btn card-exp-btn-pdf" onclick="TikTokExport.runCard('card-export-trends','trends','pdf',this)" title="Export PDF"><i class="ph ph-file-pdf export-icon"></i><span class="export-spinner"></span></button>
                                <button class="card-exp-btn card-exp-btn-img" onclick="TikTokExport.runCard('card-export-trends','trends','image',this)" title="Export PNG"><i class="ph ph-image export-icon"></i><span class="export-spinner"></span></button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
        ...
        <div class="card" style="animation:fadeUp .38s ease-out .26s both;">
            ...
            <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div data-html2canvas-ignore="true" class="d-flex gap-1">
                        <button class="card-exp-btn card-exp-btn-pdf" onclick="TikTokExport.runCard('card-export-posts','posts','pdf',this)" title="Export PDF"><i class="ph ph-file-pdf export-icon"></i><span class="export-spinner"></span></button>
                        <button class="card-exp-btn card-exp-btn-img" onclick="TikTokExport.runCard('card-export-posts','posts','image',this)" title="Export PNG"><i class="ph ph-image export-icon"></i><span class="export-spinner"></span></button>
                    </div>
                </div>
            </div>
...
@section('scripts')
    ...
    <script>
        ...
        const FEAData = {
            ...
            async loadAll() {
                if (!FEACfg.pid) {
                    EMOTIONS.forEach(id => {
                        const el = _$('kpi' + id.charAt(0).toUpperCase() + id.slice(1));
        ...
        const FEAChart = {
            ...
            renderBar() {
                ...
                makeApex('barChart', {
                    chart: {
                        ...
                        events: {
                            ...
                            dataPointSelection: (e, ctx, cfg) => {
                                const emo = EMOTIONS[cfg.dataPointIndex]; if (!emo) return;
                    ...
                    tooltip: { shared:false, intersect:true, style:{ fontFamily:'inherit', fontSize:'12px' }, y:{ formatter:(v,{dataPointIndex})=>`${numF(v)} posts (${Math.round((v/total)*100)}%)` } },
                    legend: { show:false }
                });
            },
            ...
            _doRenderTrends(posts, type) {
                ...
                const seriesData = EMOTIONS.map(e => ({ name:e.charAt(0).toUpperCase()+e.slice(1), data:dates.map(d=>dateMap[d][e]||0) }));
                ...
                }},series:seriesData,colors:EMO_COLORS_ARR,xaxis:{categories:dates,axisBorder:{show:false},axisTicks:{show:false},labels:{show:true,style:{fontSize:'10px',fontWeight:600,colors:'#94A3B8'}}},yaxis:{labels:{formatter:v=>numK(v),style:{fontSize:'10px',fontWeight:600,colors:'#94A3B8'}},axisBorder:{show:false},axisTicks:{show:false}},stroke:{curve:'smooth',width:2},fill:type==='area'?{type:'gradient',gradient:{opacityFrom:.35,opacityTo:.05,shadeIntensity:.1}}:{type:'solid',opacity:1},markers:{size:4,strokeWidth:2,strokeColors:'#fff',hover:{size:7}},grid:{borderColor:'rgba(226,232,240,.55)',strokeDashArray:3,xaxis:{lines:{show:false}},padding:{top:10,right:8,bottom:0,left:4}},legend:{position:'bottom',horizontalAlign:'left',fontSize:'11px',fontFamily:'inherit',fontWeight:600,markers:{width:8,height:8,radius:4},itemMargin:{horizontal:12,vertical:4},offsetY:4},tooltip:{shared:false,intersect:true,style:{fontFamily:'inherit',fontSize:'12px'},x:{show:true},y:{formatter:v=>numF(v)+' posts'}}});
            }
        };
        ...
        const FEAPanel = {
            ...
            _render() {
                ...
                const posts=this._posts, dummy='/assets/images/user/dummy.jpg';
        ...
        const FEADetail = {
            open(item) {
                ...
                const emo=item.emotion||'trust', ec=EMO_COLORS[emo]||'#038047';
                const name=getName(item), color2=getColor(item), av=getAvatar(item);
                const dummy='/assets/images/user/dummy.jpg';
                const avH=(av&&av.startsWith('http'))?`<img src="${esc(av)}" onerror="this.src='${dummy}'">`:`<img src="${dummy}">`;
                ...
                const sent=normSent(item), sentLbl={ pos:'Positif', neg:'Negatif', neu:'Netral' }[sent];
                ...
                const mediaHtml=videoId?`<div class="do-dp2-media"><iframe src="https://www.tiktok.com/embed/v2/${videoId}" allow="autoplay" allowfullscreen></iframe></div>`:'';
    ...
    async function _getEChartSnapshot(instance) {
        ...
        try {
            ...
            console.warn('[TikTokExport] echarts snapshot failed:', e);
            return null;
        } finally {
    ...
    /* ── Snapshot semua ApexCharts di dalam el ── */
    async function _getApexSnapshots(el) {
        ...
        for (const id of Object.keys(Charts)) {
            ...
            } catch(e) { console.warn('[TikTokExport] ApexCharts snapshot failed:', id, e); }
        }
        return snaps;
    }
    ...
    function _makeOnClone(snaps) {
        return (clonedDoc) => {
            ...
            clonedDoc.querySelectorAll('.fea-post-thumb').forEach(wrapper => {
                wrapper.querySelectorAll('img').forEach(img => { img.style.display = 'none'; });
                wrapper.querySelectorAll('.fea-post-thumb-play').forEach(p => { p.style.display = 'none'; });
            ...
            /* ★ Inject semua ECharts + ApexCharts snapshots ── kunci Safari ── */
            for (const [id, imgURI] of Object.entries(snaps)) {
                const container = clonedDoc.getElementById(id);
                if (!container || !imgURI) continue;
                const orig = _$(id);
                const h = orig ? Math.max(orig.scrollHeight, orig.offsetHeight, 280) : 280;
                container.innerHTML = '';
    ...
    async function _doCapture(el, isCard) {
        ...
        /* Force visible */
        el.querySelectorAll('.card,.kpi-card-hover,[class*="col-"],.fea-post,.fea-post-list')
          .forEach(e => {
              e.style.opacity    = '1';
        ...
        /* Kumpulkan semua snapshots SEBELUM html2canvas */
        const snaps = {};

        /* ECharts: donut */
        if (window.__feaDonut) {
            const s = await _getEChartSnapshot(window.__feaDonut);
            if (s) snaps['donutChart'] = s;
        }
        /* ECharts: radar */
        if (window._feaRadarChart) {
            const s = await _getEChartSnapshot(window._feaRadarChart);
            if (s) snaps['radarChart'] = s;
        }
        /* ApexCharts: bar, trends */
        const apexSnaps = await _getApexSnapshots(el);
        Object.assign(snaps, apexSnaps);

        /* Decode semua snapshot sebelum html2canvas */
        await Promise.allSettled(Object.values(snaps).map(src =>
            new Promise(resolve => {
                const img = new Image();
        ...
        return await html2canvas(el, {
            ...
            onclone        : d => _makeOnClone(snaps)(d),
            ignoreElements : e =>
    ...
    function _drawHeader(pdf, pW, pH, label, page, total) {
        ...
        pdf.text('SMADIMENT — ' + (label || 'TikTok Emotion Analysis'), 10, 7.5);
    ...
    async function run(type, btn) {
        ...
        try {
            ...
            if (type === 'image') {
                ...
                link.download = `tiktok_emotion_${FEA_PID}_${stamp}.png`;
                ...
                _paginate(pdf, canvas, 10, pW, pH, 'TikTok Emotion Analysis');
                pdf.save(`tiktok_emotion_${FEA_PID}_${stamp}.pdf`);
                _toast('PDF berhasil diunduh!', 'success');
            }
        } catch(err) {
            console.error('[TikTokExport.run]', err);
    ...
    function _cardFilename(k) {
        ...
        return `tiktok_emotion_${map[k] || k}_${FEA_PID}_${_stamp()}`;
    }
    ...
    async function runCard(areaId, cardKey, type, btn) {
        ...
        try {
            ...
            console.error('[TikTokExport.runCard]', err);
            _toast('Export gagal: ' + err.message, 'error');
