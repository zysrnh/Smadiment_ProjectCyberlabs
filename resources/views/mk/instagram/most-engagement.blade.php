...
const IMEExport = (() => {
    ...
    async function _exportPdf() {
        ...
        while(srcY < imgH) {
            ...
            _drawHeader(pdf, pW, margin, 'SMADIMENT — Instagram Most Engagement');
    ...
    function _cardFilename(cardKey) {
        ...
        const stamp=new Date().toISOString().slice(0,10).replace(/-/g,'');
        return `instagram_engagement_${labels[cardKey]||cardKey}_${IME_PID}_${stamp}`;
    }
