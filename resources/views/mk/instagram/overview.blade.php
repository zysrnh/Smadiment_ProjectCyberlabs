...
@endsection
@section('page-title', 'Instagram Overview')
@section('content')
...
{{-- KPI --}}
<div class="row mb-3">
    <div class="col-md-6 col-xl-3"><div class="card h-100 bg-primary text-white kpi-card-hover fade-up fade-up-d1"><div class="card-body"><div class="d-flex align-items-center"><div class="flex-grow-1"><p class="mb-1 text-white text-opacity-75 f-12">Total Likes</p><h3 class="mb-0 text-white f-w-300" id="kpiLikes"><span class="sk-block" style="width:80px;height:24px;display:inline-block;"></span></h3><p class="mb-0 mt-2 text-white text-opacity-75 f-12" id="kpiLikesSub"><i class="ph ph-heart me-1"></i>Loading…</p></div><div class="flex-shrink-0 ms-3"><div class="kpi-icon-bg"><i class="ph ph-heart"></i></div></div></div></div></div></div>
    <div class="col-md-6 col-xl-3"><div class="card h-100 bg-success text-white kpi-card-hover fade-up fade-up-d2"><div class="card-body"><div class="d-flex align-items-center"><div class="flex-grow-1"><p class="mb-1 text-white text-opacity-75 f-12">Total Comments</p><h3 class="mb-0 text-white f-w-300" id="kpiComments"><span class="sk-block" style="width:80px;height:24px;display:inline-block;"></span></h3><p class="mb-0 mt-2 text-white text-opacity-75 f-12" id="kpiCommentsSub"><i class="ph ph-chat-circle me-1"></i>Loading…</p></div><div class="flex-shrink-0 ms-3"><div class="kpi-icon-bg"><i class="ph ph-chat-circle"></i></div></div></div></div></div></div>
    <div class="col-md-6 col-xl-3"><div class="card h-100 bg-warning text-white kpi-card-hover fade-up fade-up-d3"><div class="card-body"><div class="d-flex align-items-center"><div class="flex-grow-1"><p class="mb-1 text-white text-opacity-75 f-12">Total Engagement</p><h3 class="mb-0 text-white f-w-300" id="kpiEng"><span class="sk-block" style="width:80px;height:24px;display:inline-block;"></span></h3><p class="mb-0 mt-2 text-white text-opacity-75 f-12" id="kpiEngSub"><i class="ph ph-chart-bar me-1"></i>Loading…</p></div><div class="flex-shrink-0 ms-3"><div class="kpi-icon-bg"><i class="ph ph-chart-bar"></i></div></div></div></div></div></div>
    <div class="col-md-6 col-xl-3"><div class="card h-100 bg-danger text-white kpi-card-hover fade-up fade-up-d4"><div class="card-body"><div class="d-flex align-items-center"><div class="flex-grow-1"><p class="mb-1 text-white text-opacity-75 f-12">Total Posts</p><h3 class="mb-0 text-white f-w-300" id="kpiPosts"><span class="sk-block" style="width:80px;height:24px;display:inline-block;"></span></h3><p class="mb-0 mt-2 text-white text-opacity-75 f-12" id="kpiPostsSub"><i class="ph ph-image me-1"></i>Loading…</p></div><div class="flex-shrink-0 ms-3"><div class="kpi-icon-bg"><i class="ph ph-image"></i></div></div></div></div></div></div>
</div>
                ...
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="d-flex gap-1" data-html2canvas-ignore="true">
                            <button class="card-exp-btn card-exp-btn-pdf" onclick="IGExport.runCard('card-export-hashtag-list','hashtag-list','pdf',this)" title="Export PDF"><i class="ph ph-file-pdf export-icon"></i><span class="export-spinner"></span></button>
                            <button class="card-exp-btn card-exp-btn-img" onclick="IGExport.runCard('card-export-hashtag-list','hashtag-list','image',this)" title="Export PNG"><i class="ph ph-image export-icon"></i><span class="export-spinner"></span></button>
                        </div>
                    </div>
                </div>
            ...
            <div class="card mb-3" style="animation:fadeUp .38s ease-out .22s both;">
                ...
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <div class="d-flex align-items-center gap-2 flex-wrap">
                        ...
                        <div class="d-flex gap-1" data-html2canvas-ignore="true">
                            <button class="card-exp-btn card-exp-btn-pdf" onclick="IGExport.runCard('card-export-hashtag-donut','hashtag-donut','pdf',this)" title="Export PDF"><i class="ph ph-file-pdf export-icon"></i><span class="export-spinner"></span></button>
                            <button class="card-exp-btn card-exp-btn-img" onclick="IGExport.runCard('card-export-hashtag-donut','hashtag-donut','image',this)" title="Export PNG"><i class="ph ph-image export-icon"></i><span class="export-spinner"></span></button>
                        </div>
                    </div>
                </div>
                <div class="card-body">
...
@php $panelLabels=['like'=>'Most Liked','comment'=>'Most Comments'];$panelIcons=['like'=>'ph-heart','comment'=>'ph-chat-circle']; @endphp
<div class="tme-tab-panel" id="panel-{{ $tp }}">
    ...
    <div class="card mb-3" style="animation:fadeUp .38s ease-out .18s both;">
        ...
        <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
            <div class="d-flex align-items-center gap-2">
                <div class="avtar avtar-xs bg-light-primary rounded"><i class="ph ph-chart-donut f-18 text-primary"></i></div>
                <div><h6 class="mb-0">Distribusi {{ $panelLabels[$tp] }} — Top 5</h6><small class="text-muted">Proporsi engagement per post — klik untuk detail</small></div>
            </div>
            <div class="d-flex align-items-center gap-2 flex-wrap">
                <div id="donutLegend-{{ $tp }}" class="donut-legend"></div>
                <div class="d-flex gap-1" data-html2canvas-ignore="true">
                    <button class="card-exp-btn card-exp-btn-pdf" onclick="IGExport.runCard('card-export-donut-{{ $tp }}','donut-{{ $tp }}','pdf',this)" title="Export PDF"><i class="ph ph-file-pdf export-icon"></i><span class="export-spinner"></span></button>
                    <button class="card-exp-btn card-exp-btn-img" onclick="IGExport.runCard('card-export-donut-{{ $tp }}','donut-{{ $tp }}','image',this)" title="Export PNG"><i class="ph ph-image export-icon"></i><span class="export-spinner"></span></button>
                </div>
            </div>
        </div>
        <div class="card-body">
    ...
    <div class="card mb-3" style="animation:fadeUp .38s ease-out .22s both;">
        ...
        <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="d-flex gap-1" data-html2canvas-ignore="true">
                    <button class="card-exp-btn card-exp-btn-pdf" onclick="IGExport.runCard('card-export-list-{{ $tp }}','list-{{ $tp }}','pdf',this)" title="Export PDF"><i class="ph ph-file-pdf export-icon"></i><span class="export-spinner"></span></button>
                    <button class="card-exp-btn card-exp-btn-img" onclick="IGExport.runCard('card-export-list-{{ $tp }}','list-{{ $tp }}','image',this)" title="Export PNG"><i class="ph ph-image export-icon"></i><span class="export-spinner"></span></button>
                </div>
            </div>
        </div>
...
<div class="do-panel" id="ovSntPanel">
    <div class="do-panel-header">
        ...
        <span class="do-panel-title" id="ovPanelTitle">Instagram Posts</span>
...
<script>
'use strict';
const PLAT='Instagram',API_BASE='/mk/api/instagram';
const OVCfg={pid:OV_PID,sd:OV_SD,ed:OV_ED,primary:'#038047',colors:{like:'#038047',comment:'#F59E0B',hashtag:'#038047'},perPage:10};
...
const Store={like:[],comment:[],hashtag:[]};const Pag={like:1,comment:1,hashtag:1};let allPostsRaw=[];
...
/* ── TABS ── */
const OVTab={_loaded:{hashtag:false,like:false,comment:false},show(t){TAB_TYPES.forEach(x=>{_$('tab-'+x)?.classList.toggle('active',x===t);_$('panel-'+x)?.classList.toggle('active',x===t)});if(!this._loaded[t]){this._loaded[t]=true;OVData.loadTab(t)}else if(t!=='hashtag'&&Store[t].length)OVData._renderDonut(t,Store[t]);if(t!=='hashtag')setTimeout(()=>{_$('ovTabsBar')?.scrollIntoView({behavior:'smooth',block:'nearest'})},80)},reset(){this._loaded={hashtag:false,like:false,comment:false}}};
/* ── DATA ── */
const OVData={
    ...
    async loadEngagement(type){const subMap={like:'postbylike',comment:'postbycomment'};const rows=parseInt(_$('rows-'+type)?.value||'100');const ls=_$('list-'+type);if(ls)ls.innerHTML=`<div class="spinner-state"><div class="spin-ring"></div>Memuat data…</div>`;try{const r=await fetch(`${API_BASE}/most-viewed-posts?project_id=${OVCfg.pid}&start_date=${OVCfg.sd}&end_date=${OVCfg.ed}&sub=${subMap[type]}&rows=${rows}`);const j=await r.json();let items=j.data||j||[];if(!Array.isArray(items))items=[];Store[type]=items;Pag[type]=1;const ch=_$('chip-'+type);if(ch)ch.textContent=items.length;const bd=_$('badge-'+type);if(bd)bd.textContent=items.length+' posts';if(type==='like'&&!allPostsRaw.length)allPostsRaw=items;if(type==='like')this._updateKpi(items);this._renderList(type);this._renderDonut(type,items)}catch(e){console.error('[OV]',e);if(ls)ls.innerHTML=`<div class="chart-empty" style="padding:40px;"><i class="ph ph-warning"></i><span>Gagal memuat: ${esc(e.message)}</span></div>`;hideLd('loadingDonut-'+type)}},
    _updateKpi(items){let tl=0,tc=0;items.forEach(i=>{tl+=parseInt(i.num_likes||i.likes||0);tc+=parseInt(i.num_comments||i.comments||0)});const n=items.length,av=v=>n?Math.round(v/n):0;const el=(id,v)=>{const e=_$(id);if(e)e.textContent=numF(v)};const sub=(id,v)=>{const e=_$(id);if(e)e.innerHTML=`<i class="ph ph-chart-line-up me-1"></i>Avg ${numF(av(v))} / post &middot; ${n} posts`};el('kpiLikes',tl);sub('kpiLikesSub',tl);el('kpiComments',tc);sub('kpiCommentsSub',tc);el('kpiEng',tl+tc);const eS=_$('kpiEngSub');if(eS)eS.innerHTML=`<i class="ph ph-chart-bar me-1"></i>Likes+Comments &middot; ${n} posts`;el('kpiPosts',n);const pS=_$('kpiPostsSub');if(pS)pS.innerHTML=`<i class="ph ph-image me-1"></i>Dari periode ${OVCfg.sd} s/d ${OVCfg.ed}`},
    ...
    _metric(item,type){const k={like:['num_likes','likes'],comment:['num_comments','comments']};return(k[type]||['num_likes']).reduce((v,f)=>v||parseInt(item[f]||0),0)},
    _getName(item){const n=(item.name||item.author_scr_name||item.author_name||'').replace(/<[^>]*>/g,'').trim();return n&&n!=='Instagram User'?n:'Instagram User'},
    _getAvatar(item){return(item.avatar_url||item.author_avatar||item.profile_image||item.author_image||item.profile_url||'').trim()},
    _getColor(item){const seed=item.author_id||item.id||this._getName(item)||'ig';const pal=['#e6683c','#dc2743','#cc2366','#bc1888','#038047','#273B4A','#F59E0B','#06B6D4'];let h=0;for(let i=0;i<seed.length;i++)h=(h*31+seed.charCodeAt(i))&0xffffffff;return pal[Math.abs(h)%pal.length]},
    ...
    _openHashtagPanel(h){const tag='#'+h.name.toLowerCase();const filtered=allPostsRaw.filter(p=>(p.content||p.caption||'').toLowerCase().includes(tag));OVPanel.open(filtered.length?filtered:allPostsRaw.slice(0,20),'like',`${PLAT} — #${h.name} (${h.size} mentions)`)},
};
/* ── PANEL ── */
const OVPanel={_items:[],_type:null,open(items,type,title){this._items=items||[];this._type=type;OVDetail.close();_$('ovPanelDot').style.background=OVCfg.colors[type]||OVCfg.primary;_$('ovPanelTitle').textContent=title||PLAT+' Posts';_$('ovPanelMeta').textContent=OVCfg.sd+' – '+OVCfg.ed;const ov=_$('ovPanelOverlay'),pn=_$('ovSntPanel');ov.classList.remove('hiding');pn.classList.remove('hiding');ov.classList.add('show');pn.classList.add('show');this._render(items,type)},close(){OVDetail.close();const ov=_$('ovPanelOverlay'),pn=_$('ovSntPanel');pn.classList.add('hiding');ov.classList.add('hiding');setTimeout(()=>{pn.classList.remove('show','hiding');ov.classList.remove('show','hiding')},240)},_render(items,type){const list=_$('ovPanelList');if(!list)return;if(!items?.length){list.innerHTML='<div class="do-panel-loading"><div class="do-panel-spinner"></div>Tidak ada data</div>';return}const ml={like:'Likes',comment:'Komentar'}[type]||'Likes';list.innerHTML=items.slice(0,100).map(item=>{const nm=OVData._getName(item),av=OVData._getAvatar(item),cl=OVData._getColor(item),d='/assets/images/user/dummy.jpg',aH=(av&&av.startsWith('http'))?`<img src="${esc(av)}" onerror="this.src='${d}'">`:`<img src="${d}">`,tx=(item.content||item.caption||'').replace(/<[^>]*>/g,'').trim(),mv=OVData._metric(item,type),dt=(item.date_created||'').split('T')[0],sn=OVData._normSent(item),sl={pos:'Pos',neg:'Neg',neu:'Neu'}[sn],l=parseInt(item.num_likes||item.likes||0),c=parseInt(item.num_comments||item.comments||0),total=l+c,enc=encodeURIComponent(JSON.stringify(item));return `<div class="do-panel-item" data-item="${esc(enc)}" data-type="${type}" onclick="OVPanel._click(this)"><div class="do-panel-avatar" style="background:linear-gradient(135deg,${cl},${cl}99);">${aH}</div><div class="do-panel-item-body"><div class="do-panel-author">${esc(nm)}</div><div class="do-panel-text">${esc(dec(tx).slice(0,130)||'(tidak ada konten)')}</div><div class="do-panel-footer"><span class="do-sent-badge do-sent-badge--${sn}">${sl}</span><span>${ml} ${numF(mv)}</span><span>∑ ${numF(total)}</span>${dt?`<span style="margin-left:auto;">${dt}</span>`:''}</div></div></div>`}).join('');if(items.length>100)list.insertAdjacentHTML('beforeend',`<div style="padding:8px;text-align:center;font-size:10px;font-weight:600;color:#94A3B8;background:var(--slate-50);border-top:1px dashed var(--slate-200);">+${(items.length-100).toLocaleString()} lainnya</div>`)},_click(el){try{const item=JSON.parse(decodeURIComponent(el.dataset.item.replace(/&amp;/g,'&').replace(/&lt;/g,'<').replace(/&gt;/g,'>').replace(/&quot;/g,'"')));OVDetail.open(item,el.dataset.type||this._type)}catch(e){console.warn(e)}}};
/* ── DETAIL ── */
const OVDetail={open(item,type){const panel=_$('ovDetailPanel'),body=_$('ovDetailBody'),title=_$('ovDetailTitle');if(!panel||!body)return;const color=OVCfg.colors[type]||OVCfg.primary,name=OVData._getName(item),av=OVData._getAvatar(item),ac=OVData._getColor(item),d='/assets/images/user/dummy.jpg',aH=(av&&av.startsWith('http'))?`<img src="${esc(av)}" onerror="this.src='${d}'">`:`<img src="${d}">`;const handle=item.author_scr_name||item.author_id||'';const raw=(item.content||item.caption||'').replace(/<[^>]*>/g,'').trim(),ct=raw?dec(raw):'',url=item.url||item.link||'',dt=item.date_created||'';const l=parseInt(item.num_likes||item.likes||0),c=parseInt(item.num_comments||item.comments||0);const sn=OVData._normSent(item),sl={pos:'Positif',neg:'Negatif',neu:'Netral'}[sn];let dtF='';if(dt)try{dtF=new Date(dt).toLocaleDateString('id-ID',{weekday:'long',day:'2-digit',month:'long',year:'numeric',hour:'2-digit',minute:'2-digit'})}catch(e){dtF=dt.split('T')[0]}const imgUrl=item.image||'';const mH=imgUrl?`<div class="do-dp2-media"><img src="${esc(imgUrl)}" alt="post" onerror="this.parentElement.style.display='none'"></div>`:'';title.textContent=name;body.innerHTML=`<div class="do-dp2-avatar-row"><div class="do-dp2-avatar-lg" style="background:linear-gradient(135deg,${ac},${ac}99);">${aH}</div><div><div class="do-dp2-name">${esc(name)}</div>${handle?`<div class="do-dp2-handle">@${esc(handle)}</div>`:''}<span class="do-dp2-plat-badge" style="background:#e6683c18;color:#e6683c;">Instagram</span></div></div>${dtF?`<div class="do-dp2-meta">${dtF}</div>`:''}<div class="do-dp2-sent do-dp2-sent--${sn}">${sl}</div>${mH}${ct?`<div class="do-dp2-content">${esc(ct)}</div>`:''}<div class="do-dp2-stats"><div class="do-dp2-stat"><div class="do-dp2-stat-val">${numF(l)}</div><div class="do-dp2-stat-lbl">Likes</div></div><div class="do-dp2-stat"><div class="do-dp2-stat-val">${numF(c)}</div><div class="do-dp2-stat-lbl">Comments</div></div></div>${url?`<a href="${esc(url)}" target="_blank" rel="noopener noreferrer" class="do-dp2-link"><i class="ph ph-arrow-square-out me-1"></i>Buka di Instagram</a>`:''}`;panel.classList.add('show')},close(){_$('ovDetailPanel')?.classList.remove('show')}};

/* ════════════════════════════════════════════════════════
   EXPORT MODULE — Instagram Overview
════════════════════════════════════════════════════════ */
const IGExport = (() => {
    ...
    /* Resize semua ECharts instance yang aktif */
    function _resizeAllCharts() {
        ['donutHashtagChart','donutChart-like','donutChart-comment'].forEach(id => {
            const ek = '__ec_' + id;
            if(window[ek]) { try{ window[ek].resize(); }catch(e){} }
        });
    }
    ...
    function _drawPdfHeader(doc, pW, margin, subtitle) {
        doc.setFillColor(3, 128, 71);
        doc.rect(0, 0, pW, 11, 'F');
        doc.setTextColor(255,255,255); doc.setFontSize(9); doc.setFont('helvetica','bold');
        doc.text('SMADIMENT — Instagram Overview'+(subtitle?' · '+subtitle:''), margin, 7.5);
    ...
    async function _paginateCanvasToPdf(pdf, canvas, margin) {
    ...
    async function _exportPdf() {
        ...
        const pW  = pdf.internal.pageSize.getWidth();
        _drawPdfHeader(pdf, pW, 10);
        await _paginateCanvasToPdf(pdf, canvas, 10);
        const stamp = new Date().toISOString().slice(0,10).replace(/-/g,'');
        pdf.save(`instagram_overview_${OV_PID}_${stamp}.pdf`);
    }
    ...
    async function _exportImage() {
        ...
        link.download = `instagram_overview_${OV_PID}_${stamp}.png`;
    ...
    async function _captureCard(areaId, cardKey) {
        ...
        /* resize chart di dalam card ini jika ada */
        const chartIds = {
        ...
        if(chartIds[cardKey]) {
            const ek = '__ec_'+chartIds[cardKey];
            if(window[ek]) { try{ window[ek].resize(); }catch(e){} }
        }
    ...
    const _cardLabels = {
        ...
        'hashtag-donut'  : 'Distribusi Hashtag Top 5',
        'donut-like'     : 'Distribusi Most Liked Top 5',
        'donut-comment'  : 'Distribusi Most Comments Top 5',
        'list-like'      : 'Top Posts by Likes',
        'list-comment'   : 'Top Posts by Comments',
    };
    const _cardFiles = {
        'hashtag-list'   : 'top-hashtags',
        'hashtag-donut'  : 'hashtag-donut',
        'donut-like'     : 'donut-most-liked',
        'donut-comment'  : 'donut-most-comments',
        'list-like'      : 'top-posts-by-likes',
        'list-comment'   : 'top-posts-by-comments',
    };
    ...
    async function runCard(areaId, cardKey, type, btn) {
        ...
        try {
            ...
            const stamp  = new Date().toISOString().slice(0,10).replace(/-/g,'');
            const fname  = `instagram_${file}_${OV_PID}_${stamp}`;
            if(type === 'image') {
                const link = document.createElement('a');
                ...
                const pW  = pdf.internal.pageSize.getWidth();
                _drawPdfHeader(pdf, pW, 10, label);
                await _paginateCanvasToPdf(pdf, canvas, 10);
                pdf.save(fname+'.pdf');
