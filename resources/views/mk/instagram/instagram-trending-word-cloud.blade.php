...
@section('title', 'Instagram Trending Word Cloud - SMADIMENT')
...
<style>
    ...
    .calendar-day.selected    { background: #dc2743; color: white; }
    .calendar-day.in-range    { background: rgba(220, 39, 67, 0.1); color: #dc2743; }
    .calendar-day.range-start,
    .calendar-day.range-end   { background: #dc2743; color: white; }
    ...
    .wordcloud-container {
        background: linear-gradient(135deg, #ffffff 0%, #fff8f8 50%, #f8fafc 100%);
        border-radius: 20px;
        border: 1px solid var(--border-gray);
    ...
    .wordcloud-container::before {
        ...
        top: 0; left: 0; right: 0; bottom: 0;
        background:
            radial-gradient(circle at 20% 30%, rgba(240, 148, 51, 0.04) 0%, transparent 50%),
            radial-gradient(circle at 80% 70%, rgba(188, 24, 136, 0.04) 0%, transparent 50%),
            radial-gradient(circle at 50% 50%, rgba(220, 39, 67, 0.02) 0%, transparent 70%);
        pointer-events: none;
    }

    /* Instagram decorative ring */
...
<div class="dashboard-container">
    ...
    <div class="page-header">
        ...
        <p>Visual representation of trending hashtags &amp; topics on Instagram</p>
    </div>

    <!-- Filter Card -->
    <div class="filter-card">
        <form id="filterForm" method="GET" action="{{ route('mk.instagram.trending-word-cloud') }}">
        ...
        <div class="filter-content">
            ...
            <div class="sentiment-filters">
                <button type="button" class="sentiment-btn active" data-sentiment="all">
                    <span class="sentiment-dot" style="background: var(--ig-gradient);"></span>
                    All Topics
                </button>
    ...
    <div class="wordcloud-container">
        ...
        <div id="loadingState" class="loading-state">
            ...
            <div class="loading-text" id="loadingText">Loading Instagram trending topics data...</div>
        ...
        <div class="wordcloud-hint" id="wordCloudHint">
            ...
            Click a word to search on Instagram
        </div>
...
// ========================================
// INSTAGRAM WORD CLOUD GENERATOR
// ========================================
const WordCloudGenerator = {
    ...
    // Instagram color palette (warm gradient tones)
    getSentimentColor() {
        const colorSchemes = {
            ...
            all: [
                ...
                '#c13584','#5851db','#405de6',
            ],
        };
        return colorSchemes[this.currentSentiment] || colorSchemes.all;
    },

    openInstagramSearch(topicName) {
        const tag = encodeURIComponent(topicName.replace(/^#/, ''));
        window.open(
    ...
    async init() {
        ...
        try {
            ...
            console.error('Failed to load Instagram trending data:', error);
    ...
    async loadData() {
        ...
        loadingText.textContent = 'Processing Instagram trending hashtags...';
        ...
        setTimeout(() => {
            ...
            this.chart.on('click', (params) => {
                if (params && params.data && params.data.originalTopic) {
                    this.openInstagramSearch(params.data.originalTopic.name);
                }
            });
        }, 10);
