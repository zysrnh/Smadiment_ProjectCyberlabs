...
/* ══════════════════════════════════════════════════════
   EXPORT MODULE — Net Sentiment Score
══════════════════════════════════════════════════════ */
const NSSExport = (() => {
    ...
    async function _captureCard(areaId) {
        ...
        if (areaId === 'card-nss-dist') _resizeCharts();
    ...
    async function _exportPdf() {
        ...
        const margin = 10;
        _drawPdfHeader(pdf, pW, margin, 'Net Sentiment Score');
    ...
    async function _exportImage() {
        ...
        link.download = `net_sentiment_score_${NSS_PID}_${stamp}.png`;
