    ...
    public function sharedUrlsPage(Request $request)
        {
            try {
                ...
                $projectId = $request->query(key: 'project_id');
...
/**
 * Display Most Active Users Page
 */
public function mostActiveUsersPage(Request $request)
{
    try {
        ...
        return view('mk.x.most-active-users')->with([
            'projectId' => $projectId,
            'startDate' => $startDate,
            'endDate'   => $endDate,
            'projects'  => $projects,
        ...
        Log::error('Most Active Users Page Error', [
            'error' => $e->getMessage()
        ]);
 ...
 public function aiAnalysisPage(Request $request)
    {
        try {
            ...
            return view('mk.x.ai-analysis')->with([
                'projectId' => $projectId,
                'startDate' => $startDate,
                'endDate'   => $endDate,
                'projects'  => $projects,
            ...
            Log::error('X AI Analysis Page Error', [
                'error' => $e->getMessage()
            ]);
